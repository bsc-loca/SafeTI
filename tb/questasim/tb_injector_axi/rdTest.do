...
add wave -noupdate -expand /tb_injector_axi/AXI4_M0/rd.fifo
add wave -noupdate -radix unsigned /tb_injector_axi/AXI4_M0/rd.bm_size
add wave -noupdate -radix binary /tb_injector_axi/AXI4_M0/rd.fifo_full
add wave -noupdate /tb_injector_axi/AXI4_M0/rd.fifo_last
add wave -noupdate /tb_injector_axi/AXI4_M0/rd.axi_index
add wave -noupdate /tb_injector_axi/AXI4_M0/rd.bm_index
add wave -noupdate /tb_injector_axi/AXI4_M0/rd.bm_counter
add wave -noupdate /tb_injector_axi/AXI4_M0/bm_out.rd_valid
add wave -noupdate /tb_injector_axi/AXI4_M0/bm_out.rd_done
add wave -noupdate /tb_injector_axi/AXI4_M0/bm_out.rd_data
