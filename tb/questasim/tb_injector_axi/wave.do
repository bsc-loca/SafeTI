...
add wave -noupdate -childformat {{/tb_injector_axi/axi4mo.ar_size -radix binary}} -expand -subitemconfig {/tb_injector_axi/axi4mo.ar_size {-height 18 -radix binary}} /tb_injector_axi/axi4mo
...
WaveRestoreCursors {{Cursor 1} {399 ns} 0}
