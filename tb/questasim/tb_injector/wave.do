...
add wave -noupdate -group EXE /tb_injector/core/exe/irq_desc_en
add wave -noupdate -group EXE /tb_injector/core/exe/start
add wave -noupdate -group EXE /tb_injector/core/exe/busy
add wave -noupdate -group EXE /tb_injector/core/exe/done
add wave -noupdate -group EXE /tb_injector/core/exe/irq_desc_comp
add wave -noupdate -group EXE /tb_injector/core/exe/desc_comp
add wave -noupdate -group EXE /tb_injector/core/exe/program_comp
...
add wave -noupdate -group SUB_READ /tb_injector/core/exe/sub_rd/not_last_transf
add wave -noupdate -group SUB_READ /tb_injector/core/exe/sub_rd/size_transf_rem
add wave -noupdate -group SUB_READ /tb_injector/core/exe/sub_rd/error_start
add wave -noupdate -group SUB_READ /tb_injector/core/exe/sub_rd/error_valid
add wave -noupdate -group SUB_READ /tb_injector/core/exe/sub_rd/error_done
add wave -noupdate -group SUB_READ /tb_injector/core/exe/sub_rd/status
add wave -noupdate -divider WRITE
add wave -noupdate /tb_injector/clk
add wave -noupdate /tb_injector/core/apb/apb_regs.gen_config.enable
add wave -noupdate /tb_injector/core/exe/pc_ongoing
...
add wave -noupdate -group SUB_WRITE -expand /tb_injector/core/exe/sub_wr/desc_to_exe
add wave -noupdate -group SUB_WRITE /tb_injector/core/exe/sub_wr/not_last_transf
add wave -noupdate -group SUB_WRITE /tb_injector/core/exe/sub_wr/size_transf_rem
add wave -noupdate -group SUB_WRITE /tb_injector/core/exe/sub_wr/error_start
add wave -noupdate -group SUB_WRITE /tb_injector/core/exe/sub_wr/error_full
add wave -noupdate -group SUB_WRITE /tb_injector/core/exe/sub_wr/error_done
add wave -noupdate -group SUB_WRITE /tb_injector/core/exe/sub_wr/status
add wave -noupdate -divider CONTROL
add wave -noupdate /tb_injector/core/control/irq_err_pipeline
add wave -noupdate /tb_injector/core/control/irq_err_network
add wave -noupdate /tb_injector/core/control/exe_irq_desc_comp
add wave -noupdate /tb_injector/core/control/exe_desc_comp
add wave -noupdate /tb_injector/core/control/exe_program_comp
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {61516 ns} 0}
...
update
WaveRestoreZoom {0 ns} {113033 ns}
