...
add wave -noupdate /tb_injector_axi_reset/clk
add wave -noupdate /tb_injector_axi_reset/rstn
add wave -noupdate -divider {SafeTI configure}
add wave -noupdate /tb_injector_axi_reset/core/apbi.en
add wave -noupdate -divider {AXI BUS}
add wave -noupdate /tb_injector_axi_reset/axi4mi
add wave -noupdate -childformat {{/tb_injector_axi_reset/axi4mo.aw_size -radix binary} {/tb_injector_axi_reset/axi4mo.ar_size -radix binary}} -subitemconfig {/tb_injector_axi_reset/axi4mo.aw_size {-height 18 -radix binary} /tb_injector_axi_reset/axi4mo.ar_size {-height 18 -radix binary}} /tb_injector_axi_reset/axi4mo
add wave -noupdate -divider {AXI Manager interface}
add wave -noupdate -childformat {{/tb_injector_axi_reset/AXI4_M0/wr.fifo_full -radix binary}} -subitemconfig {/tb_injector_axi_reset/AXI4_M0/wr.fifo_full {-height 18 -radix binary}} /tb_injector_axi_reset/AXI4_M0/wr
